...
- ⏯️ <kbd>Space</kbd> → Play or pause
- ⏹️ <kbd>K</kbd> → Stop playback
...
- ↩️ <kbd>←</kbd> → Seek back 5 s  
- ↪️ <kbd>→</kbd> → Seek forward 5 s

**When paused**

- 🔙 <kbd>←</kbd> → Step back 1 frame  
- 🔜 <kbd>→</kbd> → Step forward 1 frame  
- ⏮️ <kbd>⇧ Shift</kbd> + <kbd>←</kbd> → Step back 5 frames  
- ⏭️ <kbd>⇧ Shift</kbd> + <kbd>→</kbd> → Step forward 5 frames
...
- 🖥️ <kbd>F</kbd> → Toggle fullscreen  
- ⌨️ <kbd>Esc</kbd> → Exit fullscreen
...
- ⏱️ Subtitle sync offset → <kbd>⌥ Alt</kbd> + <kbd>,</kbd> shifts subtitles −50 ms, <kbd>⌥ Alt</kbd> + <kbd>.</kbd> shifts +50 ms  
