...
Before sending an invite, you can preview exactly what recipients will see. The preview shows the shared item from their perspective—including which assets are visible, what permissions they'll have, and how the content appears. This helps you verify that sensitive material isn't accidentally included and that the shared view matches your intent.
