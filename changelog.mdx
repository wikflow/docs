...
This release improves the video player, enhances the transcript experience, and refines key parts of the interface to make your workflows smoother. This is the first version with transcript support. 
